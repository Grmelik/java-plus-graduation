...
public class ErrorHandler {
    ...
    public ApiError handleException(final Throwable e) {
        ...
        return new ApiError(HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(), "Возникла ошибка на сервере",
    ...
    public ApiError handleValidate(final ValidationException e) {
        ...
        return new ApiError(HttpStatus.BAD_REQUEST.getReasonPhrase(), "Неправильно создан запрос", e.getMessage(),
                LocalDateTime.now());
    }
    ...
    public ApiError handleNotFound(final NotFoundException e) {
        ...
        return new ApiError(HttpStatus.NOT_FOUND.getReasonPhrase(), "Не найден объект", e.getMessage(),
                LocalDateTime.now());
    }
    ...
    public ApiError handleConflict(final RuntimeException e) {
        ...
        return new ApiError(HttpStatus.CONFLICT.getReasonPhrase(), "Произошел конфликт данных", e.getMessage(),
                LocalDateTime.now());
    }
